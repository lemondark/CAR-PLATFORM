          ...
          <div class="hy-search-bar2 userCenter" style="height: auto;">
            <div class="hy-sleft">
              <Form label-position="right" inline :label-width="10">
                ...
                <FormItem label="">
                  <i-select placeholder="故障等级" v-model="searchData.selfLevel" clearable filterable style="width:200px;">
          ...
          <div style="text-align:left;transform: translateX(0%) translateZ(0px);">
            <Form :model="handleData" :label-width="100">
              ...
              <Row>
                ...
                <Col span="12">
                  <FormItem label="故障等级">
                    {{handleData.selfLevel | alarmLevel}}
                  </FormItem>
                </Col>
              </Row>
              <Row>
      ...
      return {
        ...
        columnsTitle: [
          ...
          },
          {
            ...
            width: 160,
            render: (h, params) => {
              return this.__filters.alarmStatus(h, params, 'alarmStatus');
            }
          },
          {
            title: '操作',
          ...
          if (this.type === 0) {
            ...
            this.modalFormItem = [
              ...
              },
              {
                title: '故障等级',
                key: 'selfLevel',
                array: [{label: '一级', value: 1}, {label: '二级', value: 2}, {label: '三级', value: 3}, {label: '四级', value: 4}]
              },
              {
                title: '报警内容',
                key: 'alarmContent'
