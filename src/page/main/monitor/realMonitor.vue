    ...
    <div class="content alarmPageStyle">
      <div class="hy-search-bar2 realMonitor" style="height: auto;margin-left: -10px;margin-bottom:10px;">
        <Form label-position="right" inline :label-width="10">
          <FormItem label="">
            ...
            <i-input v-show="vinShow" :class="warnTip" placeholder="VIN码" v-model.trim="vinCode" style="width:260px;" :maxlength="17" clearable @on-change="autoSelect"></i-input>
          </FormItem>
      ...
      <div class="gauge">
        ...
        <Row style="background:#fafbfe;height: 250px;">
          ...
          <i-col span="4" class="card" v-show="onData.matrixVersion !== 2 && onData.matrixVersion !== 80">
            ...
            <i-col span="14" >
              <div class="hy_vehicle">
                ...
                <div class="l-info wth14">
                  ...
                  <span class="fonts" v-else><i>{{onData.bms ? (onData.bms.batterytypeCode ? (onData.bms.batterytypeCode | batteryTypeCode) : (onData.vehicle.batteryType === 1 ? '锂电池' : (batteryTypeCode === 2 ? '铅酸电池' : '--'))) : '--'}}</i></span>
                </div>
                <div class="l-info wth14">
      ...
      <div >
        ...
        <Tabs v-model="tabsName" :style="tabsHeight" style="padding-bottom: 100px;" @on-click="changeHeight">
          <Tab-pane label="实时CAN" name="real">
            <!--<h3 v-if="onData.matrixVersion === 1">GPS-->
            <!--<div class="openDetail" @click="showDetail_1()"><Icon type="chevron-down" v-if="!isShow_1"></Icon><Icon type="chevron-up" v-if="isShow_1"></Icon></div>-->
            <!--</h3>-->
            <!--<hy-detail1 :form="formData_1" :rowData="modalFormItem_1" v-if="isShow_1 && onData.matrixVersion === 1" :labelWidth="250"></hy-detail1>-->
            <!--<div :class="{'bottomLine': !isShow_1, 'hideData': isShow_1}" v-if="onData.matrixVersion === 1"></div>-->
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80">HVAC
              <div class="openDetail" @click="showDetail_2()"><Icon type="chevron-down" v-if="!isShow_2"></Icon><Icon type="chevron-up" v-if="isShow_2"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_2" :rowData="modalFormItem_2" v-if="isShow_2 && (onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_2, 'hideData': isShow_2}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion !== 2">BCM
              <div class="openDetail" @click="showDetail_3()"><Icon type="chevron-down" v-if="!isShow_3"></Icon><Icon type="chevron-up" v-if="isShow_3"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_3" :rowData="modalFormItem_3" v-if="isShow_3&&onData.matrixVersion !== 2" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_3, 'hideData': isShow_3}" v-if="onData.matrixVersion !== 2"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80 || onData.matrixVersion === 2">VMS
              <div class="openDetail" @click="showDetail_4()"><Icon type="chevron-down" v-if="!isShow_4"></Icon><Icon type="chevron-up" v-if="isShow_4"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_4" :rowData="modalFormItem_4" v-if="isShow_4 && (onData.matrixVersion === 1 || onData.matrixVersion === 80 || onData.matrixVersion === 2)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_4, 'hideData': isShow_4}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80 || onData.matrixVersion === 2"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80">PEPS
              <div class="openDetail" @click="showDetail_5()"><Icon type="chevron-down" v-if="!isShow_5"></Icon><Icon type="chevron-up" v-if="isShow_5"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_5" :rowData="modalFormItem_5" v-if="isShow_5 && (onData.matrixVersion === 1 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_5, 'hideData': isShow_5}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80">EPS
              <div class="openDetail" @click="showDetail_6()"><Icon type="chevron-down" v-if="!isShow_6"></Icon><Icon type="chevron-up" v-if="isShow_6"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_6" :rowData="modalFormItem_6" v-if="isShow_6 && (onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_6, 'hideData': isShow_6}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 3 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion === 0 || onData.matrixVersion === 1 || onData.matrixVersion === 80">ADAS
              <div class="openDetail" @click="showDetail_7()"><Icon type="chevron-down" v-if="!isShow_7"></Icon><Icon type="chevron-up" v-if="isShow_7"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_7" :rowData="modalFormItem_7" v-if="isShow_7 && (onData.matrixVersion === 0 || onData.matrixVersion === 1 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_7, 'hideData': isShow_7}" v-if="onData.matrixVersion === 0 || onData.matrixVersion === 1 || onData.matrixVersion === 80"></div>
            <h3>BMS
              <div class="openDetail" @click="showDetail_8()"><Icon type="chevron-down" v-if="!isShow_8"></Icon><Icon type="chevron-up" v-if="isShow_8"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_8" :rowData="modalFormItem_8" v-if="isShow_8" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_8, 'hideData': isShow_8}"></div>
            <h3 v-if="onData.matrixVersion !== 0">OBC
              <div class="openDetail" @click="showDetail_9()"><Icon type="chevron-down" v-if="!isShow_9"></Icon><Icon type="chevron-up" v-if="isShow_9"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_9" :rowData="modalFormItem_9" v-if="isShow_9 && (onData.matrixVersion !== 0)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_9, 'hideData': isShow_9}" v-if="onData.matrixVersion !== 0"></div>
            <h3 v-if="onData.matrixVersion !== 2">MC
              <div class="openDetail" @click="showDetail_10()"><Icon type="chevron-down" v-if="!isShow_10"></Icon><Icon type="chevron-up" v-if="isShow_10"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_10" :rowData="modalFormItem_10" v-if="isShow_10&& (onData.matrixVersion !== 2)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_10, 'hideData': isShow_10}" v-if="onData.matrixVersion !== 2"></div>
            <h3 v-if="onData.matrixVersion !== 0 && onData.matrixVersion !== 2">ACU
              <div class="openDetail" @click="showDetail_11()"><Icon type="chevron-down" v-if="!isShow_11"></Icon><Icon type="chevron-up" v-if="isShow_11"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_11" :rowData="modalFormItem_11" v-if="isShow_11 && (onData.matrixVersion !== 0 && onData.matrixVersion !== 2)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_11, 'hideData': isShow_11}" v-if="onData.matrixVersion !== 0 && onData.matrixVersion !== 2"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80">DCDC
              <div class="openDetail" @click="showDetail_12()"><Icon type="chevron-down" v-if="!isShow_12"></Icon><Icon type="chevron-up" v-if="isShow_12"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_12" :rowData="modalFormItem_12" v-if="isShow_12 && onData.matrixVersion === 1 || onData.matrixVersion === 80" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_12, 'hideData': isShow_12}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80">ICU
              <div class="openDetail" @click="showDetail_13()"><Icon type="chevron-down" v-if="!isShow_13"></Icon><Icon type="chevron-up" v-if="isShow_13"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_13" :rowData="modalFormItem_13" v-if="isShow_13 && (onData.matrixVersion === 1 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_13, 'hideData': isShow_13}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80">VERSION
              <div class="openDetail" @click="showDetail_17()"><Icon type="chevron-down" v-if="!isShow_17"></Icon><Icon type="chevron-up" v-if="isShow_17"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_17" :rowData="modalFormItem_17" v-if="isShow_17 && (onData.matrixVersion === 1 || onData.matrixVersion === 80)" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_17, 'hideData': isShow_17}" v-if="onData.matrixVersion === 1 || onData.matrixVersion === 80"></div>
            <h3 v-if="onData.matrixVersion === 0">GENERAL
              <div class="openDetail" @click="showDetail_14()"><Icon type="chevron-down" v-if="!isShow_14"></Icon><Icon type="chevron-up" v-if="isShow_14"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_14" :rowData="modalFormItem_14" v-if="isShow_14 && onData.matrixVersion === 0" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_14, 'hideData': isShow_14}" v-if="onData.matrixVersion === 0"></div>
            <h3 v-if="onData.matrixVersion === 0">MSG
              <div class="openDetail" @click="showDetail_15()"><Icon type="chevron-down" v-if="!isShow_15"></Icon><Icon type="chevron-up" v-if="isShow_15"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_15" :rowData="modalFormItem_15" v-if="isShow_15 && onData.matrixVersion === 0" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_15, 'hideData': isShow_15}" v-if="onData.matrixVersion === 0"></div>
            <h3 v-if="onData.matrixVersion === 0">TPMS
              <div class="openDetail" @click="showDetail_16()"><Icon type="chevron-down" v-if="!isShow_16"></Icon><Icon type="chevron-up" v-if="isShow_16"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_16" :rowData="modalFormItem_16" v-if="isShow_16 && onData.matrixVersion === 0" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_16, 'hideData': isShow_16}" v-if="onData.matrixVersion === 0"></div>

            <h3 v-if="onData.matrixVersion === 3">ABS
              <div class="openDetail" @click="showDetail_18()"><Icon type="chevron-down" v-if="!isShow_18"></Icon><Icon type="chevron-up" v-if="isShow_18"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_18" :rowData="modalFormItem_18" v-if="isShow_18 && onData.matrixVersion === 3" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_18, 'hideData': isShow_18}" v-if="onData.matrixVersion === 3"></div>
            <h3 v-if="onData.matrixVersion === 3">IPK
              <div class="openDetail" @click="showDetail_19()"><Icon type="chevron-down" v-if="!isShow_19"></Icon><Icon type="chevron-up" v-if="isShow_19"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_19" :rowData="modalFormItem_19" v-if="isShow_19 && onData.matrixVersion === 3" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_19, 'hideData': isShow_19}" v-if="onData.matrixVersion === 3"></div>
            <h3 v-if="onData.matrixVersion === 3">VCU
              <div class="openDetail" @click="showDetail_20()"><Icon type="chevron-down" v-if="!isShow_20"></Icon><Icon type="chevron-up" v-if="isShow_20"></Icon></div>
            </h3>
            <hy-detail1 :form="formData_20" :rowData="modalFormItem_20" v-if="isShow_20 && onData.matrixVersion === 3" :labelWidth="250"></hy-detail1>
            <div :class="{'bottomLine': !isShow_20, 'hideData': isShow_20}" v-if="onData.matrixVersion === 3"></div>
          </Tab-pane>
      ...
      <Modal v-model="canDetailShow" :mask-closable="false" width="980" :styles="{top: '20px'}">
        ...
        <div style="text-align:left">
          <can-detail ref="canDetail" v-show="canDetailShow"></can-detail>
        </div>
        <div slot="footer">
...
<script>
  ...
  import canDetail from '@/components/monitorModal/canDetail.vue';
  ...
  export default {
    ...
    methods: {
      ...
      defaultShow () {
        ...
        this.formData_19 = {};
        this.formData_20 = {};
        this.modalFormItem_1 = [];
        this.modalFormItem_2 = [];
        this.modalFormItem_3 = [];
        this.modalFormItem_4 = [];
        this.modalFormItem_5 = [];
        this.modalFormItem_6 = [];
        this.modalFormItem_7 = [];
        this.modalFormItem_8 = [];
        this.modalFormItem_9 = [];
        this.modalFormItem_10 = [];
        this.modalFormItem_11 = [];
        this.modalFormItem_12 = [];
        this.modalFormItem_13 = [];
        this.modalFormItem_14 = [];
        this.modalFormItem_15 = [];
        this.modalFormItem_16 = [];
        this.modalFormItem_17 = [];
        this.modalFormItem_18 = [];
        this.modalFormItem_19 = [];
        this.modalFormItem_20 = [];
        this.isShow = false;
        ...
        this.isShow_8 = false;
        this.isShow_9 = false;
        this.isShow_10 = false;
        this.isShow_11 = false;
        this.isShow_12 = false;
        this.isShow_13 = false;
        this.isShow_14 = false;
        this.isShow_15 = false;
        this.isShow_16 = false;
        this.isShow_17 = false;
        this.isShow_18 = false;
        this.isShow_19 = false;
        this.isShow_20 = false;
      ...
      async onMessage (event) {
        ...
        // ------默认展开数据-------------------------------------
        // d3
        this.showDetail_3(1); // bcm
        this.showDetail_7(1); // adas
        this.showDetail_8(1); // bms
        this.showDetail_10(1); // mc
        this.showDetail_14(1); // general
        this.showDetail_15(1); // msg
        // 国标
        this.showData(1);
        this.motor(1);
        this.battery(1);
        ...
        this.max(1);
        // d2 d2s
        this.showDetail_1(1); // gps
        this.showDetail_2(1); // hvac
        this.showDetail_4(1); // vms
        this.showDetail_5(1); // peps
        this.showDetail_6(1); // eps
        this.showDetail_9(1); // obc
        this.showDetail_11(1); // acu
        this.showDetail_12(1); // dcdc
        this.showDetail_13(1); // icu
        this.showDetail_16(1); // tpms
        this.showDetail_17(1); // version
        // d5
        this.showDetail_18(1); // abs
        this.showDetail_19(1); // ipk
        this.showDetail_20(1); // vcu
        ...
        if (this.onData.commProtocolVersion === 1 || this.onData.commProtocolVersion === 2) {
          ...
          if (this.onData.position) {
            ...
            this.$set(this, 'formDataD33', this.onData.position);
            // console.log(JSON.stringify(this.onData.position));
          }
          setTimeout(() => {
            this.showPosition = true;
          }, 100);
      ...
      // gps
      showDetail_1 (num) {
        // if (num) this.isShow_1 = true;
        // else this.isShow_1 = !this.isShow_1;
        this.isShowOper(num, 1);
        if (this.onData && this.onData.gps) {
          this.$set(this, 'formData_1', this.onData.gps);
          this.formData_1.collectTime1 = this.formData_1.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_1.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_1.receiveTime1 = this.formData_1.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_1.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_1 = versionData.gps;
      },
      // hvac
      showDetail_2 (num) {
        this.isShowOper(num, 2);
        if (this.onData && this.onData.hvac) {
          this.$set(this, 'formData_2', this.onData.hvac);
          this.formData_2.collectTime1 = this.formData_2.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_2.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_2.receiveTime1 = this.formData_2.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_2.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_2 = versionData.hvac_3;
        } else {
          this.modalFormItem_2 = versionData.hvac;
        }
      },
      // bcm
      showDetail_3 (num) {
        this.isShowOper(num, 3);
        if (this.onData && this.onData.bcm) {
          this.$set(this, 'formData_3', this.onData.bcm);
          this.formData_3.collectTime1 = this.formData_3.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_3.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_3.receiveTime1 = this.formData_3.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_3.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 0) {
          this.modalFormItem_3 = versionData.bcm_0;
        } else if (this.onData.matrixVersion === 1 || this.onData.matrixVersion === 80) {
          this.modalFormItem_3 = versionData.bcm_1;
        } else if (this.onData.matrixVersion === 3) {
          this.modalFormItem_3 = versionData.bcm_3;
        }
      },
      // vms
      showDetail_4 (num) {
        this.isShowOper(num, 4);
        if (this.onData && this.onData.vms) {
          this.$set(this, 'formData_4', this.onData.vms);
          this.formData_4.collectTime1 = this.formData_4.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_4.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_4.receiveTime1 = this.formData_4.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_4.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_4 = versionData.vms;
      },
      // peps
      showDetail_5 (num) {
        this.isShowOper(num, 5);
        if (this.onData && this.onData.peps) {
          this.$set(this, 'formData_5', this.onData.peps);
          this.formData_5.collectTime1 = this.formData_5.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_5.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_5.receiveTime1 = this.formData_5.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_5.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_5 = versionData.peps;
      },
      // eps
      showDetail_6 (num) {
        this.isShowOper(num, 6);
        if (this.onData && this.onData.eps) {
          this.$set(this, 'formData_6', this.onData.eps);
          this.formData_6.collectTime1 = this.formData_6.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_6.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_6.receiveTime1 = this.formData_6.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_6.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_6 = versionData.eps_3;
        } else {
          this.modalFormItem_6 = versionData.eps;
        }
      },
      // adas
      showDetail_7 (num) {
        this.isShowOper(num, 7);
        if (this.onData && this.onData.adas) {
          this.$set(this, 'formData_7', this.onData.adas);
          this.formData_7.collectTime1 = this.formData_7.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_7.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_7.receiveTime1 = this.formData_7.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_7.receiveTime), 'yyyy-MM-dd hh:mm:ss');
          if (this.onData.matrixVersion === 1) {
            if (this.formData_7.crashTime >= 0 && this.formData_7.crashTime <= 26) {
              this.formData_7.crashTime = 'The crash time for the two vehicles';
            } else {
              this.formData_7.crashTime = 'Reserved';
            }
          }
        }
        if (this.onData.matrixVersion === 0) {
          this.modalFormItem_7 = versionData.adas_0;
        } else if (this.onData.matrixVersion === 1 || this.onData.matrixVersion === 80) {
          this.modalFormItem_7 = versionData.adas_1;
        }
      },
      // bms
      showDetail_8 (num) {
        this.isShowOper(num, 8);
        if (this.onData && this.onData.bms) {
          this.$set(this, 'formData_8', this.onData.bms);
          this.formData_8.collectTime1 = this.formData_8.collectTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_8.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_8.receiveTime1 = this.formData_8.receiveTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_8.receiveTime), 'yyyy-MM-dd hh:mm:ss');
          if (this.formData_8.productionDate) {
            this.formData_8.productionDate = this._hyTool.DateFormat(new Date(+this.formData_8.productionDate), 'yyyy-MM-dd');
          }
          if (this.formData_8.batteryProDate) {
            this.formData_8.batteryProDate = this._hyTool.DateFormat(new Date(+this.formData_8.batteryProDate), 'yyyy-MM-dd');
          }
        }
        if (this.onData.matrixVersion === 0) {
          this.modalFormItem_8 = versionData.bms_0;
        } else if (this.onData.matrixVersion === 1) {
          this.modalFormItem_8 = versionData.bms_1;
        } else if (this.onData.matrixVersion === 3) {
          this.modalFormItem_8 = versionData.bms_3;
        } else if (this.onData.matrixVersion === 2 || this.onData.matrixVersion === 80) {
          this.modalFormItem_8 = versionData.bms_80;
        }
      },
      // obc
      showDetail_9 (num) {
        this.isShowOper(num, 9);
        if (this.onData && this.onData.obc) {
          this.$set(this, 'formData_9', this.onData.obc);
          this.formData_9.collectTime1 = this.formData_9.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_9.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_9.receiveTime1 = this.formData_9.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_9.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_9 = versionData.obc_3;
        } else {
          this.modalFormItem_9 = versionData.obc;
        }
      },
      // mc
      showDetail_10 (num) {
        this.isShowOper(num, 10);
        if (this.onData && this.onData.mc) {
          this.$set(this, 'formData_10', this.onData.mc);
          this.formData_10.collectTime1 = this.formData_10.collectTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_10.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_10.receiveTime1 = this.formData_10.receiveTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_10.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 0) {
          this.modalFormItem_10 = versionData.mc_0;
        } else if (this.onData.matrixVersion === 1 || this.onData.matrixVersion === 80) {
          this.modalFormItem_10 = versionData.mc_1;
        } else if (this.onData.matrixVersion === 3) {
          this.modalFormItem_10 = versionData.mc_3;
        }
      },
      // acu
      showDetail_11 (num) {
        this.isShowOper(num, 11);
        if (this.onData && this.onData.acu) {
          this.$set(this, 'formData_11', this.onData.acu);
          this.formData_11.collectTime1 = this.formData_11.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_11.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_11.receiveTime1 = this.formData_11.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_11.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_11 = versionData.acu_3;
        } else {
          this.modalFormItem_11 = versionData.acu;
        }
      },
      // dcdc
      showDetail_12 (num) {
        this.isShowOper(num, 12);
        if (this.onData && this.onData.dcdc) {
          this.$set(this, 'formData_12', this.onData.dcdc);
          this.formData_12.collectTime1 = this.formData_12.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_12.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_12.receiveTime1 = this.formData_12.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_12.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_12 = versionData.dcdc;
      },
      // icu
      showDetail_13 (num) {
        this.isShowOper(num, 13);
        if (this.onData && this.onData.icu) {
          this.$set(this, 'formData_13', this.onData.icu);
          this.formData_13.collectTime1 = this.formData_13.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_13.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_13.receiveTime1 = this.formData_13.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_13.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_13 = versionData.icu;
      },
      // general
      showDetail_14 (num) {
        this.isShowOper(num, 14);
        if (this.onData && this.onData.general) {
          this.$set(this, 'formData_14', this.onData.general);
          this.formData_14.collectTime1 = this.formData_14.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_14.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_14.receiveTime1 = this.formData_14.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_14.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_14 = versionData.general_0;
      },
      // msg
      showDetail_15 (num) {
        this.isShowOper(num, 15);
        if (this.onData && this.onData.msg) {
          this.$set(this, 'formData_15', this.onData.msg);
          this.formData_15.collectTime1 = this.formData_15.collectTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_15.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_15.receiveTime1 = this.formData_15.receiveTime === (null || undefined) ? '' : this._hyTool.DateFormat(new Date(+this.formData_15.receiveTime), 'yyyy-MM-dd hh:mm:ss');
          if (this.formData_15.insideTemperature) {
          if (this.formData_15.insideTemperature >= 0 && this.formData_15.insideTemperature <= 170) {
            this.formData_15.insideTemperature = '有效';
          } else if (this.formData_15.insideTemperature >= 171 && this.formData_15.insideTemperature <= 254) {
            this.formData_15.insideTemperature = 'Reserved';
          } else if (this.formData_15.insideTemperature === -2) {
            this.formData_15.insideTemperature = '无效';
          } else {
            this.formData_15.insideTemperature = '异常';
          }
          }
          if (this.formData_15.setTemperature) {
          if (this.formData_15.setTemperature >= 36 && this.formData_15.setTemperature <= 64) {
            this.formData_15.setTemperature = '有效';
          } else if (this.formData_15.setTemperature === -2) {
            this.formData_15.setTemperature = '无效';
          } else {
            this.formData_15.setTemperature = '异常';
          }
          }
        }
        this.modalFormItem_15 = versionData.msg_0;
      },
      // tpms
      showDetail_16 (num) {
        this.isShowOper(num, 16);
        if (this.onData && this.onData.tpms) {
          this.$set(this, 'formData_16', this.onData.tpms);
          this.formData_16.collectTime1 = this.formData_16.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_16.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_16.receiveTime1 = this.formData_16.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_16.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_16 = versionData.tpms_0;
      },
      // version
      showDetail_17 (num) {
        this.isShowOper(num, 17);
        if (this.onData && this.onData.version) {
          this.$set(this, 'formData_17', this.onData.version);
          this.formData_17.collectTime1 = this.formData_17.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_17.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_17.receiveTime1 = this.formData_17.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_17.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        this.modalFormItem_17 = versionData.version;
      },
      // abs
      showDetail_18 (num) {
        this.isShowOper(num, 18);
        if (this.onData && this.onData.abs) {
          this.$set(this, 'formData_18', this.onData.abs);
          this.formData_18.collectTime1 = this.formData_18.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_18.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_18.receiveTime1 = this.formData_18.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_18.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_18 = versionData.abs_3;
        }
      },
      // ipk
      showDetail_19 (num) {
        this.isShowOper(num, 19);
        if (this.onData && this.onData.ipk) {
          this.$set(this, 'formData_19', this.onData.ipk);
          this.formData_19.collectTime1 = this.formData_19.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_19.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_19.receiveTime1 = this.formData_19.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_19.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_19 = versionData.ipk_3;
        }
      },
      // vcu
      showDetail_20 (num) {
        this.isShowOper(num, 20);
        if (this.onData && this.onData.vcu) {
          this.$set(this, 'formData_20', this.onData.vcu);
          this.formData_20.collectTime1 = this.formData_20.collectTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_20.collectTime), 'yyyy-MM-dd hh:mm:ss');
          this.formData_20.receiveTime1 = this.formData_20.receiveTime === null ? '' : this._hyTool.DateFormat(new Date(+this.formData_20.receiveTime), 'yyyy-MM-dd hh:mm:ss');
        }
        if (this.onData.matrixVersion === 3) {
          this.modalFormItem_20 = versionData.vcu_3;
        }
      },
      getList () {
      ...
      changeHeight (key) {
        ...
        if (key === 'real') {
          if (this.onData.commProtocolVersion === 0 && this.onData.matrixVersion === 0) {
            this.tabsHeight.height = '4840px';
          } else if (this.onData.commProtocolVersion === 2) {
            this.tabsHeight.height = '3600px';
          } else {
            this.tabsHeight.height = '9940px';
          }
