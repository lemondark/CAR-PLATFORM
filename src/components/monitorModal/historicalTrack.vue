  ...
  <div class="bgcolor">
    <div class="content">
      <div class="map" id="pathMap">
        <div class="hy-search-bar2 userCenter trackColor">
  ...
  export default {
    ...
    methods: {
      ...
      reset () {
        ...
        this.location = this.locationFormat(this.arrayPoint);
        this.initPolyline();
        this.map.setFitView();
      },
      contrast (index) {
      ...
      initPolyline (flag) {
        ...
        if (flag) {
          ...
          let path = this.locationFormat(this.arrayPoint);
          //   });
          /* eslint-disable no-new */
          new AMap.Polyline({
            map: this.map,
        ...
        marker.on('moveend', () => {
          ...
          if (this.runLength < this.location.position.length) {
            this.$set(this.vehicleData, 'speed', this.location.data[this.runLength].speed ? this.location.data[this.runLength].speed : 0);
            this.$set(this.vehicleData, 'direction', this.location.data[this.runLength].direction ? this.location.data[this.runLength].direction : null);
            this.$set(this.vehicleData, 'collectTime', this.location.data[this.runLength].collectTime ? this.location.data[this.runLength].collectTime : null);
      ...
      plays () {
        //  this.location = this.removalDuplicate(this.location);
