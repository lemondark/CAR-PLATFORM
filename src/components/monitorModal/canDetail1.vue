...
<template>
  <Tabs type="card" @on-click="changeTabPane" value="gb">
    ...
    methods: {
      ...
      _getList (vinCode) {
        ...
        canList(searchData, res => {
          let list = [];
          let str = ['d2Acu', 'd2Adas', 'd2Bcm', 'd2Bms', 'd2Dcdc', 'd2Eps', 'd2Gps', 'd2Hvac', 'd2ICu',
      ...
      _getObc (row, type) {
        ...
        this.modalFormItem = [
          ...
          },
          {
            ...
            title: '输入电压状态',
            type: 'select',
            array: [{value: 0, label: '输入电压正常'}, {value: 1, label: '输入误，充电机停止工作'}]
          },
          {
            key: 'startStatus',
            title: '启动状态',
